...
import { View, Text, Button, StyleSheet, ImageBackground, StatusBar, AppState, Platform } from 'react-native'; 
  ...
  >
    <Text style={styles.greeting}>{greeting}</Text>
      ...
      <View style={styles.authButtonContainer}> 
        <Button title="Log In" onPress={() => navigation.navigate('Login')} color="#ff6347" /> 
          <Button title="Sign Up" onPress={() => navigation.navigate('SignUp')} color="#ff6347" /> 
          </View>
